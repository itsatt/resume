...
const translations = {
  zh: {
    ...
    'timeline-1-title': '毕业入行 · 基础夯实',
    'timeline-1-desc': '太原科技大学光电信息科学与工程专业毕业，开始自学 NLP 和机器学习基础',
    'tag1-1': 'Python 编程',
    'tag1-2': '深度学习基础',
    'tag1-3': 'Transformer',
    'timeline-2-title': 'Prompt Engineering · LLM 入门',
    'timeline-2-desc': '系统性学习 Prompt Engineering，掌握 Role/Context/Task 框架、Few-shot、CoT 等技术',
    'tag2-1': 'Prompt 设计',
    'tag2-2': '结构化输出',
    'tag2-3': '思维链',
    'timeline-3-title': 'RAG 系统 · 工程实践',
    'timeline-3-desc': '深入 RAG 系统开发，掌握多路召回、Rerank 重排序、Embedding 优化等核心技术',
    'tag3-1': 'LangChain',
    'tag3-2': '向量检索',
    'tag3-3': 'BGE 模型',
    'timeline-4-title': 'Agent / 本地部署 · 能力扩展',
    'timeline-4-desc': '探索 ReAct Agent 工作流，实现 Qwen-3.8B 本地部署与 LoRA 微调，形成完整工程能力',
    'tag4-1': 'ReAct',
    'tag4-2': 'Qwen',
    'tag4-3': 'LoRA',
    'tag4-4': 'vLLM',
    ...
    'project-1-title': '智能检索增强生成系统',
    'project-1-desc': '多路召回 + 动态重排序 + 安全护栏，检索准确率提升 47%',
    'metric-accuracy': '准确率提升',
    'metric-latency': 'P95 延迟',
    'metric-availability': '可用性',
    'view-details': '查看详情',
    'view-details-arrow': '查看详情 →',
    'project-2-title': 'ReAct 工作流引擎',
    'project-2-desc': '推理 + 行动循环，支持多工具编排与失败恢复',
    'project-3-tag': 'Local LLM',
    'project-3-title': 'Qwen-3.8B 本地部署',
    'project-3-desc': 'LoRA 微调 + vLLM 推理优化，成本降低 83%',
    ...
    'diagram-input': '输入',
    'diagram-input-docs': 'PDF/TXT/Excel',
    'diagram-parse': '文档解析',
    'diagram-parse-desc': '统一处理',
    'diagram-retrieve': '多路召回',
    'diagram-retrieve-desc': 'BM25 + 向量 + 规则',
    'diagram-rerank-desc': 'BGE-Reranker',
    'diagram-safety': '安全护栏',
    'diagram-safety-desc': '注入检测/敏感词',
    'diagram-generate': '生成',
    'diagram-generate-desc': 'Prompt 模板化',
    'section-tech-solution': '技术方案',
    'tech-parse-layer': '文档解析层',
    'tech-parse-layer-desc': 'PDF / TXT / Excel 多源数据统一处理，支持大文件分块流式处理',
    'tech-retrieve-layer': '检索层',
    'tech-retrieve-layer-desc': 'BM25 关键词检索 + Chroma/FAISS 向量检索 + 正则规则检索，三路召回',
    'tech-sort-layer': '排序层',
    'tech-sort-layer-desc': 'Rerank 精细排序 + 置信度判定 + 上下文压缩，只保留关键信息',
    'tech-safety-layer': '安全层',
    'tech-safety-layer-desc': '提示注入检测、敏感词过滤、越权限制、低置信度降级',
    'card-performance': '性能指标',
    'card-tech-stack': '技术栈',
    'metric-docs': '文档处理量',
    'optimization-title': '关键优化点',
    'optimization-desc': '解决实际工程问题的具体方案',
    'opt-1-title': 'Embedding 批处理优化',
    'opt-1-desc': '解决长任务卡死问题',
    'opt-1-result': '超时率从 12% → 0.3%',
    'opt-2-title': '正则匹配 + 规则分析',
    'opt-2-desc': '输入输出安全防护',
    'opt-2-result': '拦截 99.7% 注入尝试',
    'opt-3-title': 'Query Rewrite',
    'opt-3-desc': '模糊问题改写提升召回',
    'opt-3-result': '召回相关性 +35%',
    'opt-4-title': '多路召回权重融合',
    'opt-4-desc': 'RRF 倒数排名融合',
    'opt-4-result': '复杂问题覆盖率 +28%',
    'result-label': '结果：',
    'project-2-title': 'ReAct 智能体工作流引擎',
  ...
  en: {
    ...
    'timeline-1-title': 'Graduation · Foundation Building',
    'timeline-1-desc': 'Graduated from Taiyuan University of Science & Technology, started self-studying NLP and machine learning',
    'tag1-1': 'Python Programming',
    'tag1-2': 'Deep Learning Basics',
    'tag1-3': 'Transformer',
    'timeline-2-title': 'Prompt Engineering · LLM Introduction',
    'timeline-2-desc': 'Systematically learned Prompt Engineering, mastered Role/Context/Task framework, Few-shot, CoT',
    'tag2-1': 'Prompt Design',
    'tag2-2': 'Structured Output',
    'tag2-3': 'Chain of Thought',
    'timeline-3-title': 'RAG System · Engineering Practice',
    'timeline-3-desc': 'Deep dive into RAG development, mastered multi-path recall, Rerank, Embedding optimization',
    'tag3-1': 'LangChain',
    'tag3-2': 'Vector Search',
    'tag3-3': 'BGE Model',
    'timeline-4-title': 'Agent / Local Deployment · Capability Expansion',
    'timeline-4-desc': 'Explored ReAct Agent workflow, implemented Qwen-3.8B local deployment and LoRA fine-tuning',
    'tag4-1': 'ReAct',
    'tag4-2': 'Qwen',
    'tag4-3': 'LoRA',
    'tag4-4': 'vLLM',
    ...
    'project-1-title': 'Intelligent RAG System',
    'project-1-desc': 'Multi-path recall + dynamic reranking + safety guards, 47% accuracy improvement',
    ...
    'project-2-title': 'ReAct Workflow Engine',
    'project-2-desc': 'Reason-Act loop with multi-tool orchestration and failure recovery',
    'project-3-tag': 'Local LLM',
    'project-3-title': 'Qwen-3.8B Local Deployment',
    'project-3-desc': 'LoRA fine-tuning + vLLM inference optimization, 83% cost reduction',
    ...
    'diagram-input': 'Input',
    'diagram-input-docs': 'PDF/TXT/Excel',
    'diagram-parse': 'Document Parsing',
    'diagram-parse-desc': 'Unified Processing',
    'diagram-retrieve': 'Multi-path Retrieval',
    'diagram-retrieve-desc': 'BM25 + Vector + Rules',
    'diagram-rerank-desc': 'BGE-Reranker',
    'diagram-safety': 'Safety Guards',
    'diagram-safety-desc': 'Injection Detection/Sensitive Words',
    'diagram-generate': 'Generation',
    'diagram-generate-desc': 'Prompt Templating',
    'section-tech-solution': 'Technical Solution',
    'tech-parse-layer': 'Document Parsing Layer',
    'tech-parse-layer-desc': 'Unified processing for PDF/TXT/Excel multi-source data, supports chunked streaming for large files',
    'tech-retrieve-layer': 'Retrieval Layer',
    'tech-retrieve-layer-desc': 'BM25 keyword search + Chroma/FAISS vector search + regex rules, three-path recall',
    'tech-sort-layer': 'Sorting Layer',
    'tech-sort-layer-desc': 'Rerank fine sorting + confidence assessment + context compression, keeping only key information',
    'tech-safety-layer': 'Safety Layer',
    'tech-safety-layer-desc': 'Prompt injection detection, sensitive word filtering, privilege restrictions, low-confidence degradation',
    'card-performance': 'Performance Metrics',
    'card-tech-stack': 'Tech Stack',
    'metric-docs': 'Documents Processed',
    'optimization-title': 'Key Optimizations',
    'optimization-desc': 'Specific solutions for real engineering problems',
    'opt-1-title': 'Embedding Batch Processing',
    'opt-1-desc': 'Solving long task freezing issues',
    'opt-1-result': 'Timeout rate from 12% → 0.3%',
    'opt-2-title': 'Regex Matching + Rule Analysis',
    'opt-2-desc': 'Input/Output security protection',
    'opt-2-result': 'Blocked 99.7% injection attempts',
    'opt-3-title': 'Query Rewrite',
    'opt-3-desc': 'Fuzzy question rewriting to improve recall',
    'opt-3-result': 'Recall relevance +35%',
    'opt-4-title': 'Multi-path Recall Weight Fusion',
    'opt-4-desc': 'RRF reciprocal rank fusion',
    'opt-4-result': 'Complex question coverage +28%',
    'result-label': 'Result:',
    'project-2-title': 'ReAct Agent Workflow Engine',
